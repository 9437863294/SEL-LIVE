...
const formatDateSafe = (dateInput: any) => {
    // This is a simplified version. For production, a more robust date parser is needed.
    if (!dateInput) return 'N/A';
    try {
      // Assuming dateInput is a string like "2025-11-11" or a Firestore Timestamp
        ...
        <div className="flex-1 min-h-0 overflow-y-auto pr-6 -mr-6">
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4 text-sm">
              ...
              <div><Label>Work Order No.</Label><p className="font-medium">{bill.workOrderNo}</p></div>
              <div><Label>Bill Date</Label><p className="font-medium">{formatDateSafe(bill.billDate)}</p></div>
            </div>
