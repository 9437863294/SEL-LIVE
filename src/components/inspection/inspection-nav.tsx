...
/**
 * The Inspection screens as one consistent cross-link bar, mirroring the other module navs. It
 * moves between this gate's own screens; there is no longer a bar that steps across the supply
 * gates themselves.
 *
