...
const SETTINGS_ITEMS = [
  ...
  {
    icon: Link2,
    text: 'E-Approval Bridge',
    href: '/recurring-payments/settings/e-approval',
    description: 'Mirror each payment’s workflow into E-Approval, so one task appears in both.',
