...
const moduleDescriptions: Record<string, string> = {
  ...
  'Site Fund Request': 'Submit and approve site fund requests with workflow.',
    ...
    'Recurring Payments': 'Manage recurring bills, approvals, due dates, and payments.',
    'Letter of Credit Management': 'Control LC requests, limits, collateral, bills, payments, recoveries, and closure.',
    'Fixed Deposit Management': 'Manage FD principal, BG/LC utilisation, availability, maturities, and interest.',
