        ...
        <div className="w-full max-w-4xl mx-auto">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Define the approval process for JMC entries.</CardDescription>
                </CardHeader>
                                    ...
                                    <AccordionContent>
                                        <div className="space-y-6 p-4 border-t">
                                            ...
                                            <div className="space-y-2">
                                             ...
                                             <div className="space-y-2">
                                                <Label>Alternative User (Optional)</Label>
                                                <Select
                                            ...
                                            <div className="space-y-4">
                                                <Label>Actions available at this step</Label>
                                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                                    {allActions.map(action => (
                                                        <div key={action} className="flex items-center space-x-2">
                                                            <Checkbox
                                                                id={`${step.id}-action-${action}`}
                                                                checked={step.actions.some(a => (typeof a === 'string' ? a : a.name) === action)}
