            ...
            <Table>
              <TableHeader className="bg-muted">
                <TableRow>
                  ...
                  <TableHead className="text-center">Loan/Investment</TableHead>
              ...
              <TableBody>
                {isLoading ? (
                  Array.from({ length: 5 }).map((_, i) => (
                    <TableRow key={i}>
                      <TableCell colSpan={16}><Skeleton className="h-8" /></TableCell>
                    </TableRow>
                  ))
                  ...
                  loansWithDetails.map(loan => (
                    <TableRow key={loan.id} className="cursor-pointer hover:bg-muted/50" onClick={() => handleRowClick(loan.id)}>
                      ...
                      <TableCell className="text-center">{loan.loanType === 'Investment' ? 'Investment' : 'Loan'}</TableCell>
                  ...
                  <TableRow>
                    <TableCell colSpan={16} className="text-center h-24">No loans found.</TableCell>
                  </TableRow>
                )}
              </TableBody>
            </Table>
