        ...
        <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="space-y-2">
                    <Label htmlFor="departmentId">Generated by Department</Label>
                    <Select name="departmentId" onValueChange={(value) => handleSelectChange('departmentId', value)} value={expense.departmentId}>
