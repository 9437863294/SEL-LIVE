...
export default function MvacReportsPage() {
    ...
    const reportItemsBase = [
      { 
        icon: BarChart4, 
        text: 'MVAC Summary', 
        description: 'A summary of MVAC status and progress.',
        href: `/billing-recon/${projectSlug}/mvac/reports/mvac-summary`,
    ...
    const reportItems = reportItemsBase.map(item => ({
        ...item,
        disabled: !can(item.permission, 'Billing Recon.MVAC') || item.disabled,
    }));
        ...
        return (
            <div className="w-full max-w-lg">
                <div className="mb-6 flex items-center gap-4">
                    ...
                    <h1 className="text-2xl font-bold">MVAC Reports</h1>
                </div>
                <Card>
                    <CardHeader>
                        <CardTitle>Access Denied</CardTitle>
                        <CardDescription>You do not have permission to view MVAC reports.</CardDescription>
                    </CardHeader>
