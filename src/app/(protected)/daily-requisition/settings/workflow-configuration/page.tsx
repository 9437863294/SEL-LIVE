                    ...
                    <div className="space-y-6 border-t border-white/70 p-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Shown to the assignee when this step is active. Optional but recommended.
                        </p>
                        <Textarea
                          id={`desc-${step.id}`}
                          value={step.description || ''}
                          onChange={(e) => handleStepChange(step.id, 'description', e.target.value)}
                          placeholder="e.g. Review attached invoice, verify GST and TDS amounts, then proceed..."
                          disabled={!canEditPage}
                      ...
                      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Users notified (in-app) when this step becomes active.
                          </p>
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Auto-escalate to this user when TAT is running out.
                          </p>
                          <Select
                            value={step.escalationUserId || 'none'}
                            onValueChange={(v) =>
                              handleStepChange(step.id, 'escalationUserId', v === 'none' ? '' : v)
                            }
                            disabled={!canEditPage}
                          >
                            <SelectTrigger>
                          ...
                          {step.escalationUserId && (
                            <div className="space-y-1 pt-1">
                              <Label className="text-xs text-muted-foreground">
                                Escalate after what % of TAT is elapsed
                              </Label>
                              <div className="flex items-center gap-2">
                                <Input
                                  ...
                                  onChange={(e) =>
                                    handleStepChange(step.id, 'escalationThreshold', Number(e.target.value))
                                  }
                                  disabled={!canEditPage}
                                  className="w-20"
                                />
