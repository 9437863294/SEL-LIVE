  ...
  useEffect(() => {
    const fetchDeptsAndProjects = async () => {
      ...
      try {
        ...
        toast({
          title: "Error",
          description: "Failed to load initial data for roles.",
          variant: "destructive",
        });
      }
      setIsLoading(false);
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 mt-0.5">
                Build a reusable permission set for your team.
              </p>
            </div>
          </div>
          <Button
                ...
                >
                  {filteredModules.map(([moduleName, moduleValue]) => {
                    ...
                    const isViewModulePermission =
                      (newRole.permissions?.[moduleName] || []).includes(
                        "View Module",
                                ...
                                {moduleValue.map((permission) => (
                                  ...
                                  >
                                    <Checkbox
                                      ...
                                      checked={(
                                        newRole.permissions?.[moduleName] || []
                                      ).includes(permission)}
