...
export default function WorkflowConfigurationPage() {
  ...
  const canViewPage = useMemo(
    () => !isAuthLoading && safeCan3(can, 'View Workflow', 'Site Fund Request.Settings'),
    [isAuthLoading, can],
  );
  const canEditPage = useMemo(
    () => !isAuthLoading && safeCan3(can, 'Edit Workflow', 'Site Fund Request.Settings'),
    [isAuthLoading, can],
  );
  ...
  async function handleSave() {
    ...
    try {
        ...
        await logUserActivity({
            ...
            recordId: 'site-fund-request',
            recordRef: 'Site Fund Request Workflow',
        });
      ...
      <div className="w-full px-3 py-4 sm:px-4 lg:px-6 xl:px-8">
        <div className="mb-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/site-fund-request/settings"><Button variant="ghost" size="icon"><ArrowLeft className="h-6 w-6" /></Button></Link>
            <div>
