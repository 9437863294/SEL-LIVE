...
import { CheckCircle2, History, RefreshCw, Search, Shield, X } from 'lucide-react';
...
const EVENT_CFG: Record<EventType, { cls: string; dot: string }> = {
  'Policy Created': { cls: 'bg-blue-100 text-blue-700 border-blue-200',    dot: 'bg-blue-500' },
  'Premium Paid':   { cls: 'bg-emerald-100 text-emerald-700 border-emerald-200', dot: 'bg-emerald-500' },
};
    ...
    <div className="space-y-4">
      ...
      <Card className="overflow-hidden border-border/60">
        ...
        <CardHeader className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <CardTitle className="tracking-tight">Personal Insurance History</CardTitle>
              <CardDescription>Complete activity log — policy creations and premium payments</CardDescription>
            </div>
          </div>
      ...
      <div className="flex items-center gap-2">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search policy no., holder, user…" className="pl-8 h-9 text-sm" />
