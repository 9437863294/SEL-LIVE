...
export const RP_FORM_REGISTRY: Record<RPFormKey, RPFormDef> = {
  master: {
    ...
    fields: [
      ...
      { key: "billingCycle", defaultLabel: "Billing cycle", defaultRequired: false },
      { key: "generationDateRule", defaultLabel: "Generation rule", defaultRequired: false },
      { key: "dueDateRule", defaultLabel: "Due-date rule", defaultRequired: false },
      { key: "dueDay", defaultLabel: "Due day / offset", defaultRequired: false },
      { key: "gracePeriodDays", defaultLabel: "Grace period days", defaultRequired: false },
      { key: "generateBeforeDueDays", defaultLabel: "Generate before due (days)", defaultRequired: false },
