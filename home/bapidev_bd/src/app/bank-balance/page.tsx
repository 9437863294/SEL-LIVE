        ...
        accounts.forEach(account => {
            ...
            if (account.openingDate) {
                ...
                accountTransactions.forEach(t => {
                    ...
                    if (isCC) { // Cash Credit: Debit increases utilization, Credit decreases it
                        runningBalance += (t.type === 'Debit' ? amount : -amount);
                    } else { // Current Account: Credit increases balance, Debit decreases it
